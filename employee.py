...
class employeeClass:
    def __init__(self,root):
        ...
        lbl_pass=Label(self.root,text="Passwword",font=("goudy old style",15),bg="white").place(x=350,y=230)
        ...
        cmb_utype=ttk.Combobox(self.root,textvariable=self.var_utype,values=("Admiin","Employee"),state='readonly',justify=CENTER,font=("goudy old style",15))
        ...
        try:
            if self.var_emp_id.get()=="" :
                ...
                if row==None:
                    ...
                    op=messagebox.askyesno("Confiirm","Do you really want to delete?", parent=self.root)
                    if op==True:
