...
class IMS:
    def __init__(self,root):
        ...
        self.root.title("Inventory Management System | Developed by Aryaman")
        ...
        self.lbl_supplier=Label(self.root,text="Total Supplier\n [ 1 ]",bd=5,relief=RIDGE,bg="#ff5722",fg="white",font=("goudy old style",20,"bold"))
        self.lbl_supplier.place(x=625,y=120,height=150,width=250)

        self.lbl_category=Label(self.root,text="Total Category\n [ 2 ]",bd=5,relief=RIDGE,bg="#009688",fg="white",font=("goudy old style",20,"bold"))
        self.lbl_category.place(x=950,y=120,height=150,width=250)
        ...
        self.lbl_sales=Label(self.root,text="Total Sales\n [ 4 ]",bd=5,relief=RIDGE,bg="#ffc107",fg="white",font=("goudy old style",20,"bold"))
        self.lbl_sales.place(x=625,y=300,height=150,width=250)


         #====footer====
        lbl_footer=Label(self.root,text="IMS- Inventory Management System | Developed by Aryaman\nFor any technical issue contact 8928296778",font=("times new roman",12),bg="#4d636d",fg="white").pack(side=BOTTOM,fill=X)
